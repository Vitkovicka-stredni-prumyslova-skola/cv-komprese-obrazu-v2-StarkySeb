namespace Komprese
{
    public class KompreseObrazu{
        ...
        String testFilePath = @"C:\Users\SebastiánStarý\github-classroom\Vitkovicka-stredni-prumyslova-skola\cv-komprese-obrazu-v2-StarkySeb\KompreseObrazu\CSV\obr1-10.csv";
